...
if (LanguageON != "" ){
    ...
    var Change_idioma_ESP = function () {
        location.reload();
        window.location.href = '../../secciones/p11-atavio-florido/index.php'+'?idioma='+'ESP';
    };
    
    
    var Change_idioma_ENG = function () {
        location.reload();
        window.location.href = '../../secciones/p11-atavio-florido/index.php'+'?idioma='+'ENG';
    };
    
    var Change_idioma_NAH = function () {
        location.reload();
        window.location.href = '../../secciones/p11-atavio-florido/index.php'+'?idioma='+'NAH';
    };
