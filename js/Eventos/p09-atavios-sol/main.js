...
if (LanguageON != "" ){
    ...
    var Change_idioma_ESP = function () {
        location.reload();
        window.location.href = '../../secciones/p09-atavios-sol/index.html'+'#'+'ESP';
    };
    
    
    var Change_idioma_ENG = function () {
        location.reload();
        window.location.href = '../../secciones/p09-atavios-sol/index.html'+'#'+'ENG';
    };
    
    var Change_idioma_NAH = function () {
        location.reload();
        window.location.href = '../../secciones/p09-atavios-sol/index.html'+'#'+'NAH';
    };
...
$(".btn_hotspots-LG").click(function() {
    ...
    $(".imagen-AS-"+num_gal_HP+"-"+num_init_HP).fadeIn();
