...
if (LanguageON != "" ){
    ...
    var Change_idioma_ESP = function () {
        location.reload();
        window.location.href = '../../secciones/p10-atavios-de-tierra/index.html'+'?idioma='+'ESP';
    };
    
    
    var Change_idioma_ENG = function () {
        location.reload();
        window.location.href = '../../secciones/p10-atavios-de-tierra/index.html'+'?idioma='+'ENG';
    };
    
    var Change_idioma_NAH = function () {
        location.reload();
        window.location.href = '../../secciones/p10-atavios-de-tierra/index.html'+'?idioma='+'NAH';
    };
...
$(".btn_hotspots-LG").click(function() {
    ...
    $(".imagen-AT-"+num_gal_HP+"-"+num_init_HP).fadeIn();
