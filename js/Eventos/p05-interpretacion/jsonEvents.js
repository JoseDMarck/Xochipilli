...
// Textos Galerias
document.getElementById("btn_lectura").innerHTML = obj_NAH.botones[0].btn_lectura; 
document.getElementById("btn_atavios_sol").innerHTML = obj_NAH.botones[0].btn_atavios_sol;
document.getElementById("btn_atavios_tierra").innerHTML = obj_NAH.botones[0].btn_atavios_tierra; 
document.getElementById("btn_atavios_florido").innerHTML = obj_NAH.botones[0].btn_atavios_florido; 
document.getElementById("btn_trono").innerHTML = obj_NAH.botones[0].btn_trono; 
