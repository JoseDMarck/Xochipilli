...
<head>
	...
	<title>Con la piel de la tierra</title>
...
<div class="main">
	<div class="lectura-general-Seccion">
			...
			<div class="titulo_Atavios_Tierra"></div>


			<div class="LecturaGnral-BloqueB">
				 <div class="asset_figura_03t_1">
				 	 <div class="btn_hotspots-LG btn_L-1-1_HP btn_pos_03t_1_h01"></div>
				 	 <div class="btn_hotspots-LG btn_L-1-2_HP btn_pos_03t_1_h02"></div>
				 	 <div class="btn_hotspots-LG btn_L-1-3_HP btn_pos_03t_1_h03"></div>
				 ...
				 <div class="asset_figura_03t_2">
				 	 <div class="btn_hotspots-LG btn_L-2-1_HP btn_pos_03t_2_h01"></div>
				 	 <div class="btn_hotspots-LG btn_L-2-2_HP btn_pos_03t_2_h02"></div>
				 	 <!--<div id="titulo_btn_2" class="titulos_btn"></div>-->

				 </div>


				 <div class="asset_figura_03t_3">
				 	 <div class="btn_hotspots-LG btn_L-3-1_HP btn_pos_03t_3_h01"></div>
				 	 <div class="btn_hotspots-LG btn_L-3-2_HP btn_pos_03t_3_h02"></div>
				 	 <div class="btn_hotspots-LG btn_L-3-3_HP btn_pos_03t_3_h03"></div>
			...
			<div class="PopUpSlider_HP">
				...
				<div class="imagen_PopUpSlider">
					...
					<div class="gal_img imagen-AT-1-1"></div>
					<div id="gal_desc-1-1" class="gal_desc_LG desc-1-1"></div>

					<div class="gal_img imagen-AT-1-2"></div>
					...
					<div class="gal_img imagen-AT-3-2"></div>
...
<script type="text/javascript" src="../../js/Eventos/p10-atavios-de-tierra/main.js"></script>
