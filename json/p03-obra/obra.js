...
var obj_ESP_Obra = {
    titulo: "Obra",
    descripcion: "<p>Para esta tercera edición de la serie <i>Una pieza, Una cultura</i> se presenta a <i>Xochipilli, el Señor de las Flores</i>, como escultura emblemática y de manufactura exquisita, obra cumbre del arte mexicano, para dejar que hable sobre la riqueza, belleza, complejidad y diversidad de los habitantes de la cuenca de México y la multitud de pueblos que construyeron la gloria mexica.</p><p>Xochipilli pertenece a la tradición escultórica de Chalco al sureste de la Cuenca de México y está fechada en el periodo Posclásico Tardío (1250-1521 d.C.).</p><p>La escultura está hecha de andesita, una roca de origen volcánico muy abundante en las laderas del volcán Iztaccíhuatl, área donde se excavó en el siglo XIX, cerca de Tlalmanalco, hoy Estado de México. La pieza está registrada como parte de la colección del Museo Nacional de Antropología desde 1882, cuando aparece por primera vez en los catálogos del antiguo Museo Nacional después de haber sido donada por Alfredo Chavero.</p><p>El hecho de haber sido labrado en la región chalca, de gran tradición escultórica y artística, particularmente fértil y en donde se honraba con especial devoción a Xochipilli como deidad de la fertilidad vegetal y de las flores, se traduce en los rasgos tan característicos que le dan todo su simbolismo, carácter estético y belleza. Observando cada uno de sus detalles, se van descubriendo no sólo las ideas alrededor de Xochipilli como deidad, sino el sistema de creencias de la vasta, diversa y compleja cultura mexica.</p></br></br>",
};
...
var obj_ENG_Obra = {
    titulo: "Work",
    descripcion: "<p>As the third installment in the series <i>One Piece, One Culture</i>, the masterpiece <i>Xochipilli, Lord of Flowers</i>, is presented as an exquisitely carved sculpture emblematic of Mexica art. It is introduced to speak for itself on the richness, beauty, complexity, and diversity of the inhabitants of the Basin of Mexico and the multitude of peoples who constructed Mexica glory.</p><p>Xochipilli belongs to the sculptural tradition of Chalco, a town southeast of the Basin of Mexico, and dates to the Late Postclassic (A.D. 1250–1521).</p><p>The sculpture is carved from andesite, a volcanic rock extremely abundant on the slopes of Mount Iztaccihuatl, the area where it was excavated in the nineteenth century, near Tlalmanalco, today in the State of Mexico. The piece had been registered as part of the collection of the National Museum of Anthropology since 1882, when it appears for the first time in the catalogues of the former National Museum, after it had been donated by Alfredo Chavero.</p><p>The piece was worked in the Chalco region, a particularly fertile region where Xochipilli was honored with special reverence as the deity responsible for the fertility of plants and flowers. Chalco was also renowned for its longstanding sculptural and artistic tradition, here translated into the characteristic features that give the deity with its symbolic and aesthetic character, as well as its beauty. Observing each of its details allows you to discover not only ideas related to Xochipilli as a deity, but also the system of beliefs in the vast, diversified, and complex Mexica universe.</p></br></br>",
};
